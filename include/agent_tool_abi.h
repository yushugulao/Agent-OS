...
/* Deprecated compatibility id; new callers use AGENT_TOOL_CONTEXT_STATUS. */
#define AGENT_TOOL_CTX_STAT          3
#define AGENT_TOOL_QUERY_PROCESS     4
#define AGENT_TOOL_GET_SYSTEM_STATUS 5
#define AGENT_TOOL_CONTEXT_STATUS    6
#define AGENT_TOOL_READ_CONTEXT      AGENT_TOOL_CONTEXT_STATUS
#define AGENT_TOOL_QUERY_FILE        7
#define AGENT_TOOL_SEND_MESSAGE      8
#define AGENT_TOOL_READ_MESSAGE      9
#define AGENT_TOOL_METADATA_INIT     10
#define AGENT_TOOL_FILE_META_INIT    AGENT_TOOL_METADATA_INIT
...
#define AGENT_TOOL_HEARTBEAT_CONFIGURE 18
#define AGENT_TOOL_AGENT_HEARTBEAT   AGENT_TOOL_HEARTBEAT_CONFIGURE
...
#define AGENT_TOOL_APPLY_PATCH       27
#define AGENT_TOOL_WRITE_FILE        28
#define AGENT_TOOL_SEARCH_FILES      29
#define AGENT_TOOL_READ_WORKSPACE_FILE 30
#define AGENT_TOOL_INSPECT_SYSTEM    31
#define AGENT_TOOL_BUILD_UCORE_PROGRAM 32
#define AGENT_TOOL_RUN_UCORE_PROGRAM 33
#define AGENT_TOOL_COUNT             33

#define AGENT_TOOL_F_CALLABLE     1ULL
#define AGENT_TOOL_F_SYSCALL_ONLY 2ULL
#define AGENT_TOOL_F_DEPRECATED   4ULL
#define AGENT_TOOL_F_BROKERED     8ULL
...
#define AGENT_PARAM_KEY_REGISTRY(X) \
	...
	X(ARTIFACT_HANDLE, "artifact_handle") \
	X(EXPECTED_REV, "expected_rev")
