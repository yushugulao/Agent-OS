...
def default_batch_payload() -> str:
    actions = {
        "actions": [
            ...
            {"path": "/actions/research/workbench-file-manifest", "payload": {"workbench": "usable-workbench:RUN-WEB", "manifest": "delivery-manifest.json"}},
            {"path": "/actions/research/workbench-file-verify", "payload": {"workbench": "usable-workbench:RUN-WEB", "manifest": "delivery-manifest.json"}},
