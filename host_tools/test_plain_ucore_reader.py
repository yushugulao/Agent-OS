...
""",
    ...
    "rp_agentcmp": (
        ...
        "knowledge_index=search_documents:1685;provenance_nodes:406;provenance_links:544;events:8966;context_records:380;usable_artifacts:507;usable_runs:23;status=ready\n"
        "llm_transcripts=99;llm_bridge_requests=33;llm_bridge_responses=33;workbenches=8;deliveries=9;studio_sessions=2;project_action_plans=17;project_runbooks=17;project_evidence_audits=17;project_provenance_graphs=4;status=ready\n"
        "research_portfolio=sources:67;datasets:5;literature_searches:7;reviews:11;evidence_reviews:7;evidence_extractions:25;screening_decisions:25;exports:80;doctor_reports:12;project_handoff_audits:34;project_run_comparisons:17;project_reproducibility_audits:17;project_snapshot_comparisons:17;status=ready\n"
        "agentcompare_execution_scale=reports:4;results:20;profiles:1;plain_runs:5;indexed_runs:5;real_artifact_runs:5;status=ready\n"
        ...
        "content_graph_scale=content_objects:129;object_references:129;host_content_objects:129;host_object_references:129;status=ready\n"
        "host_operations_scale=audit_records:5;metrics:13;llm_providers:3;secret_references:3;executed_corr_ids:4;usable_projects:23;artifacts:128;messages:70;status=ready\n"
        ...
        "root_state_surface=projects:1;runs:1;reports:1;plans:1;search_records:2;site_exports:1;compare_profiles:1;audit:5;context:380;project:lab-gene-x;run:RUN-042;status=ready\n"
    ),
    "rp_calculation": (
        "service=calculation\n"
        "run_id=RUN-042\n"
            ...
            json.dumps(
                {
                    ...
                    "plain": {
                        ...
                        "run": {"status": "ready", "passed": True, "embedded_action_records": 44, "extracted_state_files": 256},
                        "failures": [],
                    },
                    "agentos": {
                        "status": "ready",
                        "prepare": {"actions": 44, "accepted": 44},
                        "run": {"status": "ready", "passed": True, "embedded_action_records": 44, "extracted_state_files": 268},
                        "failures": [],
                    },
                    "failures": [],
                }
