...
CONTROL_PLANE_POLICY = (
    ...
    ("semantic-replay", "host_tools/remote_ci_archive.py"),
    ("semantic-replay", "host_tools/remote_ci_bundle.py"),
    ("semantic-replay", "host_tools/remote_ci_evidence.py"),
    ("semantic-replay", "host_tools/remote_ci_job_semantics.py"),
