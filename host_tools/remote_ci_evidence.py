...
SOURCE_CONTRACT_FILES = (
    ...
    "host_tools/benchmark_source_contract.py",
    ...
    "host_tools/compare_dual_platform_state.py",
    "host_tools/dual_state_archive.py",
    "host_tools/dual_state_evidence_contract.py",
    "host_tools/evidence_semantic_common.py",
    "host_tools/evidence_semantic_dual.py",
    ...
    "host_tools/reference_catalog_contract.py",
