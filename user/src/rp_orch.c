...
int main(void)
{
	...
	state_ok = state_ok && rp_file_contains("rp_status", "workbench_readiness=ready");
	state_ok = state_ok && rp_file_contains("rp_status", "workbench_answer=ready");
	state_ok = state_ok && rp_file_contains("rp_status", "workbench_brief=ready");
	state_ok = state_ok && rp_file_contains("rp_status", "workbench_runbook=ready");
	state_ok = state_ok && rp_file_contains("rp_status", "workbench_timeline=ready");
	state_ok = state_ok && rp_file_contains("rp_status", "workbench_manifest=ready");
	...
	state_ok = state_ok && rp_file_contains("rp_relay", "queue_consumer=rp_llm_relay");
	state_ok = state_ok && rp_file_contains("rp_relay", "request_validation=passed");
	...
	state_ok = state_ok && rp_file_contains("rp_llmq", "queue_validation=passed");
	state_ok = state_ok && rp_file_contains("rp_llmq", "dispatch_ready=3");
	state_ok = state_ok && rp_file_contains("rp_llmeval", "passed=7");
	state_ok = state_ok && rp_file_contains("rp_llmeval", "fallback_checks=3");
	...
	state_ok = state_ok && rp_file_contains("rp_llmlog", "secret_scan=passed");
	...
	state_ok = state_ok && rp_file_contains("rp_llm_packets", "validated_packets=3");
	state_ok = state_ok && rp_file_contains("rp_llm_packets", "packet_schema=passed");
	...
	state_ok = state_ok && rp_file_contains("rp_llm_routes", "route_policy=deterministic_then_host_optional");
	state_ok = state_ok && rp_file_contains("rp_llm_guard", "secrets_in_ucore=0");
	state_ok = state_ok && rp_file_contains("rp_llm_guard", "blocked_packets=0");
	state_ok = state_ok && rp_file_contains("rp_llm_hostreq", "cloud_mode=optional_host_side");
	state_ok = state_ok && rp_file_contains("rp_llm_hostreq", "host_request_manifest=ready");
	...
	state_ok = state_ok && rp_file_contains("rp_llm_fallback", "fallback_trace=rp_llm_guard->rp_llm_fallback->rp_llm_resp");
	...
	state_ok = state_ok && rp_file_contains("rp_llm_resp", "response_join=passed");
	...
	state_ok = state_ok && rp_file_contains("rp_consistency", "checks=107");
	...
	state_ok = state_ok && rp_file_contains("rp_runner", "workbench_readiness=rp_workbench_ready;status=ready");
	state_ok = state_ok && rp_file_contains("rp_runner", "workbench_answer=rp_workbench_answer;citations=5;status=ready");
	state_ok = state_ok && rp_file_contains("rp_runner", "workbench_brief=rp_workbench_brief;handoff=ready");
	state_ok = state_ok && rp_file_contains("rp_runner", "workbench_runbook=rp_workbench_runbook;commands=6");
	state_ok = state_ok && rp_file_contains("rp_runner", "workbench_timeline=rp_workbench_timeline;events=8");
	state_ok = state_ok && rp_file_contains("rp_runner", "workbench_file_manifest=rp_workbench_manifest;files=9;sha_records=9");
	state_ok = state_ok && rp_file_contains("rp_runner", "next_action=build_delivery_manifest");
	state_ok = state_ok && rp_file_contains("rp_runner", "citation_count=5");
	state_ok = state_ok && rp_file_contains("rp_runner", "handoff=ready");
	state_ok = state_ok && rp_file_contains("rp_runner", "continuation_guide=ready");
	state_ok = state_ok && rp_file_contains("rp_runner", "event=exported;source=rp_package");
	state_ok = state_ok && rp_file_contains("rp_runner", "sha_records=9");
	...
	state_ok = state_ok && rp_file_contains("rp_tests", "tests=653");
