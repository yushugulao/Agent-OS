...
int main(void)
{
	...
	state_ok = state_ok && rp_file_contains("rp_web_routes", "routes=18");
	state_ok = state_ok && rp_file_contains("rp_web_routes", "get_routes=13");
	...
	state_ok = state_ok && rp_file_contains("rp_tests", "tests=132");
