...
int main(void)
{
	...
	state_ok = state_ok && rp_file_contains("rp_web_routes", "routes=21");
	...
	state_ok = state_ok && rp_file_contains("rp_tests", "tests=340");
	...
	state_ok = state_ok && (rp_count_lines("rp_tool") >= 143);
