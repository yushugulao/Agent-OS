...
int main(void)
{
	...
	if (!rp_append_file("rp_agentcmp", "real_task_checks=96;dataset=palmer-penguins;rows=344;numeric_fields=5;answer_audit=pass;bundle=ready;status=ready")) return 1;
