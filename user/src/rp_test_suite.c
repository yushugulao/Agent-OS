...
int main(void)
{
	...
	ok = ok && require_file_token("rp_backend", "cases=8");
	ok = ok && require_file_token("rp_backend", "agentos_mainflow_kernel=required");
	ok = ok && require_file_token("rp_backend", "agentos_mainflow_facts=12");
	...
	ok = ok && require_file_token("rp_backend_exec", "case=agentos-ucore;source=rp_agentos_kernel;status=passed");
	ok = ok && require_file_token("rp_backend_exec", "portability_rehearsal_cases=4");
	ok = ok && require_file_token("rp_backend_exec", "runner_cases=8");
	ok = ok && require_file_token("rp_backend_exec", "runner_case=plain-ucore;input=rp_wfio;artifact=rp_artifact_manifest;result=passed");
	...
	ok = ok && require_file_token("rp_backend_exec", "runner_case=agentos-context;input=rp_agentos_kernel;artifact=agent_context;result=passed");
	ok = ok && require_file_token("rp_backend_exec", "runner_case=agentos-fsmeta;input=rp_agentos_kernel;artifact=agent_file_meta;result=passed");
	ok = ok && require_file_token("rp_backend_exec", "runner_case=agentos-recovery;input=rp_agentos_recovery;artifact=rp_fix;result=passed");
	ok = ok && require_file_token("rp_backend_exec", "runner_case=agentos-event;input=rp_agentos_timeline+rp_agentos_collab_ack;artifact=rp_agent_run;result=passed");
	ok = ok && require_file_token("rp_backend_exec", "runner_case=agentos-audit;input=rp_agentos_audit;artifact=rp_audit;result=passed");
	ok = ok && require_file_token("rp_backend_exec", "runner_case=agentos-edit;input=rp_agentos_conflict;artifact=agent_file_edit;result=passed");
	...
	ok = ok && require_file_token("rp_backend_exec", "runner_case=agentos-context;input=rp_agentos_kernel;artifact=agent_context;result=passed;reason=kernel_context;input_check=pass;artifact_check=pass;att=1;retry=none;ticks=1");
	ok = ok && require_file_token("rp_backend_exec", "runner_case=agentos-fsmeta;input=rp_agentos_kernel;artifact=agent_file_meta;result=passed;reason=kernel_metadata;input_check=pass;artifact_check=pass;att=1;retry=none;ticks=1");
	ok = ok && require_file_token("rp_backend_exec", "runner_case=agentos-recovery;input=rp_agentos_recovery;artifact=rp_fix;result=passed;reason=kernel_action_commit;input_check=pass;artifact_check=pass;att=1;retry=generic_action;ticks=1");
	ok = ok && require_file_token("rp_backend_exec", "runner_case=agentos-event;input=rp_agentos_timeline+rp_agentos_collab_ack;artifact=rp_agent_run;result=passed;reason=kernel_event_queue;input_check=pass;artifact_check=pass;att=1;retry=none;ticks=1");
	ok = ok && require_file_token("rp_backend_exec", "runner_case=agentos-audit;input=rp_agentos_audit;artifact=rp_audit;result=passed;reason=kernel_ledger;input_check=pass;artifact_check=pass;att=1;retry=none;ticks=1");
	ok = ok && require_file_token("rp_backend_exec", "runner_case=agentos-edit;input=rp_agentos_conflict;artifact=agent_file_edit;result=passed;reason=kernel_edit_lease;input_check=pass;artifact_check=pass;att=1;retry=none;ticks=1");
	...
	ok = ok && require_file_token("rp_backend_exec", "runner_detail=agentos-context;src=rp_agentos_kernel;req=context_path;obs=pass;act=context_snapshot;review=observed");
	ok = ok && require_file_token("rp_backend_exec", "runner_detail=agentos-fsmeta;src=rp_agentos_kernel;req=metadata_index;obs=pass;act=file_meta_init;review=observed");
	ok = ok && require_file_token("rp_backend_exec", "runner_detail=agentos-recovery;src=rp_agentos_recovery;req=action_commit+artifact_update;obs=pass;act=generic_kernel_tools;review=verified");
	ok = ok && require_file_token("rp_backend_exec", "runner_detail=agentos-event;src=rp_agentos_timeline+rp_agentos_collab_ack;req=event_wait_wake;obs=pass;act=kernel_queue;review=verified");
	ok = ok && require_file_token("rp_backend_exec", "runner_detail=agentos-audit;src=rp_agentos_audit;req=audit+provenance;obs=pass;act=ledger_snapshot;review=verified");
	ok = ok && require_file_token("rp_backend_exec", "runner_detail=agentos-edit;src=rp_agentos_conflict;req=file_edit_lease;obs=pass;act=edit_begin_commit;review=verified");
	ok = ok && require_file_token("rp_backend_exec", "runner_detail_rows=8");
	...
	ok = ok && require_file_token("rp_backend_exec", "runner_report=agentos-context;plain_cost=rebuild_steps_6;agentos_replace=kernel_context_path;risk=untrusted_context;status=passed");
	ok = ok && require_file_token("rp_backend_exec", "runner_report=agentos-fsmeta;plain_cost=scan_records_128;agentos_replace=metadata_index;risk=scan_growth;status=passed");
	ok = ok && require_file_token("rp_backend_exec", "runner_report=agentos-recovery;plain_cost=manual_retry_contract;agentos_replace=capability_checked_action;risk=wrong_object_update;status=passed");
	ok = ok && require_file_token("rp_backend_exec", "runner_report=agentos-event;plain_cost=file_polling;agentos_replace=kernel_event_queue;risk=lost_handoff;status=passed");
	...
	ok = ok && require_file_token("rp_backend_exec", "runner_report=agentos-edit;plain_cost=userland_lock_file;agentos_replace=kernel_edit_lease;risk=lost_update;status=passed");
	ok = ok && require_file_token("rp_backend_exec", "runner_report_rows=8");
	ok = ok && require_file_token("rp_backend_exec", "runner_report_schema=plain_cost,agentos_replace,risk,status");
	ok = ok && require_file_token("rp_backend_exec", "runner_observed=rp_stage_state,rp_retry_plan,rp_artifact_manifest,rp_llmeval,rp_agentos_kernel,rp_agentos_mainflow,rp_agentos_recovery,rp_agentos_query,rp_agentos_timeline,rp_agentos_audit,rp_agentos_workbench,rp_agentos_package,rp_agentos_real_task,rp_agentos_conflict");
	ok = ok && require_file_token("rp_backend_exec", "runner_detail_fields=input_check,artifact_check,att,retry,ticks");
	ok = ok && require_file_token("rp_backend_exec", "runner_detail_checks=32");
	ok = ok && require_file_token("rp_backend_exec", "runner_verified_inputs=8");
	ok = ok && require_file_token("rp_backend_exec", "runner_passed=8");
	ok = ok && require_file_token("rp_backend_exec", "runner_planned=0");
	...
	ok = ok && require_file_token("rp_study", "metrics=13");
	...
	ok = ok && require_file_token("rp_agentos_kernel", "mode=kernel_agent_orchestrated");
	ok = ok && require_file_token("rp_agentos_kernel", "agent_context=present");
	ok = ok && require_file_token("rp_agentos_kernel", "dependency_update=generic_record");
	ok = ok && require_file_token("rp_agentos_kernel", "prefetch_hint=dependency_driven");
	ok = ok && require_file_token("rp_agentos_recovery", "context_snapshot=trusted");
	ok = ok && require_file_token("rp_agentos_query", "metadata_source=kernel_file_index");
	...
	ok = ok && require_file_token("rp_agentos_mainflow", "permission_control=sentinel_action_denied");
	...
	ok = ok && require_file_token("rp_agentos_mainflow", "edit_lease=kernel_exclusive");
	ok = ok && require_file_token("rp_agentos_conflict", "holder_write=checked");
	...
	ok = ok && require_file_token("rp_runner", "backend_evidence_report=rp_backend_exec;plain_costs=8;agentos_replacements=8;risks=8;status=ready");
	ok = ok && require_file_token("rp_report_text", "backend_evidence_report=rp_backend_exec;plain_costs=file_scan_manifest,retry_file_stage_file,rebuild_steps_6,scan_records_128,manual_retry_contract,file_polling,append_only_logs,userland_lock_file;agentos_replacements=batch_tool_context,event_context,kernel_context_path,metadata_index,capability_checked_action,kernel_event_queue,kernel_ledger_provenance,kernel_edit_lease,workbench_file_verify,package_trace,real_task_context;dependency_graph=kernel_records;mainflow_facts=12;status=ready");
	...
	ok = ok && require_file_token("rp_ui_compare", "agentos_kernel=mainflow_bound");
	ok = ok && require_file_token("rp_ui_compare", "agentos_context_snapshot=1");
	ok = ok && require_file_token("rp_ui_compare", "agentos_metadata_index=1");
	ok = ok && require_file_token("rp_ui_compare", "agentos_batch_tool=1");
	...
	ok = ok && require_file_token("rp_api_compare", "agentos_kernel=mainflow_bound");
	ok = ok && require_file_token("rp_api_compare", "agentos_context_snapshot=1");
	ok = ok && require_file_token("rp_api_compare", "agentos_metadata_index=1");
	ok = ok && require_file_token("rp_api_compare", "agentos_batch_tool=1");
	...
	ok = ok && require_file_token("rp_review_dashboard", "backend_review_evidence=rp_backend_exec;plain_costs=4;agentos_replacements=4;risks=4;review_pack=rp_review_pack;status=ready");
	...
	ok = ok && require_file_token("rp_agentcmp", "portability_backend_checks=18");
	...
	ok = ok && require_file_token("rp_agentcmp", "passed_cases=8");
	ok = ok && require_file_token("rp_agentcmp", "planned_cases=0");
	ok = ok && require_file_token("rp_agentcmp", "backend_runner_checks=24");
	ok = ok && require_file_token("rp_agentcmp", "backend_runner_detail_checks=48");
	ok = ok && require_file_token("rp_agentcmp", "runner_detail_rows=8");
	ok = ok && require_file_token("rp_agentcmp", "backend_runner_report_checks=40");
	ok = ok && require_file_token("rp_agentcmp", "runner_report_rows=8");
	ok = ok && require_file_token("rp_agentcmp", "backend_report_links=2");
	ok = ok && require_file_token("rp_agentcmp", "runner_cases=8");
	ok = ok && require_file_token("rp_agentcmp", "runner_passed=8");
	...
	ok = ok && require_file_token("rp_modelreg", "agentos_context=observed");
	ok = ok && require_file_token("rp_modelreg", "agentos_metadata=observed");
	ok = ok && require_file_token("rp_modelreg", "agentos_provenance=observed");
	ok = ok && require_file_token("rp_modelver", "version=model-version:agent-triage-template:v1");
	ok = ok && require_file_token("rp_modelver", "agentos_version_trace=kernel_context_path");
	ok = ok && require_file_token("rp_modeleval", "metric_evidence_coverage=1.000");
	ok = ok && require_file_token("rp_modeleval", "agentos_evaluation_event=observed");
	ok = ok && require_file_token("rp_modeldep", "check_secret_policy=not_required");
	ok = ok && require_file_token("rp_modeldep", "agentos_capability_check=deployment_policy");
	ok = ok && require_file_token("rp_modelserve", "latency_ms=12");
	ok = ok && require_file_token("rp_modelserve", "agentos_serving_watch=observed");
	...
	ok = ok && require_file_token("rp_expsched", "agentos_context=observed");
	ok = ok && require_file_token("rp_schedtask", "agentos_task_context=observed");
	ok = ok && require_file_token("rp_schedbook", "agentos_booking_metadata=observed");
	ok = ok && require_file_token("rp_schedconf", "agentos_conflict_event=observed");
	ok = ok && require_file_token("rp_schedexec", "agentos_execution_trace=observed");
	...
	ok = ok && require_file_token("rp_traincomp", "agentos_context=observed");
	ok = ok && require_file_token("rp_trainreq", "requirement=training-req:sop-deviation:qa-lead");
	ok = ok && require_file_token("rp_trainreq", "agentos_requirement_metadata=observed");
	ok = ok && require_file_token("rp_trainrec", "training=training:qa-lead:sop-deviation");
	ok = ok && require_file_token("rp_trainrec", "agentos_training_context=observed");
	ok = ok && require_file_token("rp_trainassess", "assessment=competency:qa-lead:sop-deviation");
	ok = ok && require_file_token("rp_trainassess", "agentos_assessment_event=observed");
	ok = ok && require_file_token("rp_trainauth", "authorization=auth:qa-lead:qa-lead:lab-gene-x");
	ok = ok && require_file_token("rp_trainauth", "agentos_authorization_capability=observed");
	ok = ok && require_file_token("rp_traingap", "status=resolved");
	ok = ok && require_file_token("rp_traingap", "agentos_gap_event=observed");
	...
	ok = ok && require_file_token("rp_runbooks", "agentos_adaptation=event_context,kernel_timeline,metadata_index,batch_recovery_tool;evidence=rp_agentos_mainflow,rp_agentos_timeline,rp_agentos_query,rp_agentos_recovery;result=observed;status=ready");
	...
	ok = ok && require_file_token("rp_agentcmp", "runbook_kernel_binding=event_context,kernel_timeline,metadata_index,batch_recovery_tool;source=rp_runbooks;status=ready");
	...
	ok = ok && require_file_token("rp_stdesign", "agentos_metadata=observed");
	ok = ok && require_file_token("rp_stdesign", "agentos_provenance=observed");
	ok = ok && require_file_token("rp_power", "required_per_group=11");
	ok = ok && require_file_token("rp_power", "status=underpowered");
	ok = ok && require_file_token("rp_power", "agentos_context_record=power_analysis");
	ok = ok && require_file_token("rp_random", "assignments=4");
	ok = ok && require_file_token("rp_random", "status=balanced");
	ok = ok && require_file_token("rp_random", "agentos_file_metadata=randomization_plan");
	ok = ok && require_file_token("rp_blind", "status=ok");
	ok = ok && require_file_token("rp_blind", "agentos_capability_check=blinding_roles");
	ok = ok && require_file_token("rp_streview", "stat_result=approved_with_sample_size_note");
	ok = ok && require_file_token("rp_streview", "agentos_review_trace=kernel_context_path");
	...
	ok = ok && require_file_token("rp_control", "agentos_adaptation=kernel_capability_check,kernel_event_delivery,kernel_plugin_tool_table,kernel_run_queue;evidence=rp_agentos_mainflow,rp_agentos_roles,rp_agentos_timeline,rp_agentos_kernel;result=observed;status=ready");
	...
	ok = ok && require_file_token("rp_agentcmp", "control_plane_kernel_binding=capability_check,event_delivery,tool_table,agent_run_queue;source=rp_control;status=ready");
	...
	ok = ok && require_file_token("rp_integrity", "agentos_adaptation=kernel_context_attestation,kernel_metadata_reference_index,kernel_event_trace,kernel_namespace_registry;evidence=rp_agentos_mainflow,rp_agentos_query,rp_agentos_timeline,rp_agentos_package;result=observed;status=ready");
	...
	ok = ok && require_file_token("rp_agentcmp", "integrity_kernel_binding=context_attestation,metadata_reference_index,event_trace,namespace_registry;source=rp_integrity;status=ready");
	...
	ok = ok && require_file_token("rp_coherence", "agentos_adaptation=kernel_run_state_views,kernel_tool_contract_table,kernel_delivery_metadata,kernel_agent_coordination_trace;evidence=rp_agentos_mainflow,rp_agentos_kernel,rp_agentos_package,rp_agentos_collab_ack;result=observed;status=ready");
	ok = ok && require_file_token("rp_review_dashboard", "subsection=coherence_plane;source=rp_coherence;checks=40;errors=0;result=passed;status=ready");
	...
	ok = ok && require_file_token("rp_agentcmp", "coherence_kernel_binding=run_state_views,tool_contract_table,delivery_metadata,agent_coordination_trace;source=rp_coherence;status=ready");
	...
	ok = ok && require_file_token("rp_publication", "agentos_adaptation=kernel_submission_metadata,kernel_review_event_queue,kernel_response_context,kernel_release_gate;evidence=rp_agentos_package,rp_agentos_timeline,rp_agentos_mainflow,rp_agentos_roles;result=observed;status=ready");
	...
	ok = ok && require_file_token("rp_pubplan", "agentos_showcase=plain_userland_vs_kernel_assisted;evidence=rp_agentos_package,rp_agentos_timeline,rp_agentos_mainflow,rp_agentos_roles;result=observed;status=ready");
	...
	ok = ok && require_file_token("rp_agentcmp", "publication_kernel_binding=submission_metadata,review_event_queue,response_context,release_gate;source=rp_publication;status=ready");
	...
	ok = ok && require_file_token("rp_calculation", "agentos_kernel_metadata=observed");
	ok = ok && require_file_token("rp_calculation", "agentos_context=observed");
	ok = ok && require_file_token("rp_calculation", "agentos_provenance=observed");
	...
	ok = ok && require_file_token("rp_calc_files", "agentos_file_metadata=calculation_outputs");
	...
	ok = ok && require_file_token("rp_calc_parse", "agentos_context_record=parser_summary");
	...
	ok = ok && require_file_token("rp_calc_export", "agentos_package_trace=kernel_provenance");
	...
	ok = ok && require_file_token("rp_analysisres", "agentos_context=observed");
	ok = ok && require_file_token("rp_anplan", "plan=analysis-plan:RUN-042:treatment-response");
	ok = ok && require_file_token("rp_anplan", "agentos_plan_context=observed");
	ok = ok && require_file_token("rp_anrun", "run=analysis-run:RUN-042:manual");
	ok = ok && require_file_token("rp_anrun", "agentos_run_event=observed");
	ok = ok && require_file_token("rp_resulttbl", "table=result-table:manual");
	ok = ok && require_file_token("rp_resulttbl", "agentos_table_metadata=observed");
	ok = ok && require_file_token("rp_statres", "stat=stat-result:manual");
	ok = ok && require_file_token("rp_statres", "agentos_stat_metadata=observed");
	ok = ok && require_file_token("rp_anfig", "figure=figure:manual");
	ok = ok && require_file_token("rp_anfig", "agentos_figure_metadata=observed");
	ok = ok && require_file_token("rp_interp", "interpretation=interpretation:manual");
	ok = ok && require_file_token("rp_interp", "agentos_interpretation_context=observed");
	...
	ok = ok && require_file_token("rp_campaign", "agentos_context=observed");
	ok = ok && require_file_token("rp_campaign", "agentos_metadata=observed");
	ok = ok && require_file_token("rp_campaign", "agentos_provenance=observed");
	...
	ok = ok && require_file_token("rp_trials", "agentos_file_metadata=campaign_trials");
	...
	ok = ok && require_file_token("rp_camp_rank", "agentos_context_record=campaign_ranking");
	...
	ok = ok && require_file_token("rp_resreview", "agentos_package_trace=kernel_provenance");
	...
	ok = ok && require_file_token("rp_reldossier", "agentos_context=observed");
	ok = ok && require_file_token("rp_reldossier", "agentos_metadata=observed");
	ok = ok && require_file_token("rp_reldossier", "agentos_provenance=observed");
	...
	ok = ok && require_file_token("rp_reldsec", "agentos_context_record=release_dossier_sections");
	ok = ok && require_file_token("rp_relattest", "attestations=4");
	ok = ok && require_file_token("rp_relattest", "agentos_file_metadata=release_attestations");
	...
	ok = ok && require_file_token("rp_relpack", "agentos_package_trace=kernel_provenance");
	...
	ok = ok && require_file_token("rp_decsupport", "agentos_context=observed");
	ok = ok && require_file_token("rp_decopt", "option=agentos_ucore_hybrid");
	ok = ok && require_file_token("rp_decopt", "kernel_observed=1");
	...
	ok = ok && require_file_token("rp_package", "decision_support=rp_decsupport;options=3;criteria=5;scores=15;selected=agentos_ucore_hybrid;status=ready");
	ok = ok && require_file_token("rp_web_bundle", "decision_support_page=rp_decsupport;options=3;criteria=5;scores=15;selected=agentos_ucore_hybrid;status=ready");
	ok = ok && require_file_token("rp_review_dashboard", "subsection=decision_support;source=rp_decsupport;options=3;criteria=5;scores=15;selected=select_agentos_ucore_hybrid;status=ready");
	...
	ok = ok && require_file_token("rp_usable", "kernel_assisted=1");
	...
	ok = ok && require_file_token("rp_usableops", "kernel_event_queue=observed");
	ok = ok && require_file_token("rp_package", "usable_research=rp_usable;templates=3;datasets=3;library_sources=3;dag_stages=9;deliverables=8;kernel_assisted=1;status=ready");
	ok = ok && require_file_token("rp_web_bundle", "usable_research_page=rp_usable;templates=3;datasets=3;library_sources=3;dag_stages=9;queues=2;kernel_assisted=1;status=ready");
	ok = ok && require_file_token("rp_review_dashboard", "subsection=usable_research;source=rp_usable;checks=100;handoff=ready;kernel_assisted=1;status=ready");
	...
	ok = ok && require_file_token("rp_usableproj", "kernel_assisted=1");
	ok = ok && require_file_token("rp_usableboot", "kernel_doctor=context_snapshot,file_metadata,event_queue,capability_guard;status=observed");
	ok = ok && require_file_token("rp_usablescaf", "agentos_meta=dataset");
	ok = ok && require_file_token("rp_usablelaunch", "kernel_context=recorded");
	ok = ok && require_file_token("rp_usablepack", "metadata=indexed");
	ok = ok && require_file_token("rp_package", "usable_project=rp_usableproj;scaffolds=3;launches=2;bundles=2;doctor=pass;kernel_assisted=1;status=ready");
	ok = ok && require_file_token("rp_web_bundle", "usable_project_page=rp_usableproj;scaffolds=3;launches=2;bundles=2;doctor=pass;kernel_assisted=1;status=ready");
	ok = ok && require_file_token("rp_review_dashboard", "subsection=usable_project;source=rp_usableproj;checks=120;bundles=2;kernel_assisted=1;status=ready");
	...
	ok = ok && require_file_token("rp_prov_view", "agentos_kernel_timeline=observed");
	ok = ok && require_file_token("rp_prov_view", "agentos_kernel_provenance=observed");
	ok = ok && require_file_token("rp_prov_view", "agentos_kernel_ledger=observed");
	...
	printf("rp_test_suite: tests=2800 catalog=passed state_catalog=passed startup_doctor=passed model_registry=passed systematic_review=passed experiment_scheduling=passed training_compliance=passed runbook_service=passed project_delivery=passed study_protocol=passed statistical_design=passed operations_board=passed review_board=passed control_plane=passed integrity_plane=passed coherence_plane=passed publication_workflow=passed calculation=passed real_task=passed analysis_results=passed decision_support=passed usable_research=passed usable_project=passed experiment_campaigns=passed release_dossier=passed mature_capabilities=passed provenance_view=passed provenance_query=passed data=passed services=passed products=passed assurance=passed research_ops=passed regulated=passed lab_governance=passed knowledge_index=passed llm_transcripts=passed workbench_delivery=passed portfolio_scale=passed execution_scale=passed operations_scale=passed project_revision_incident=passed reserved_research_surfaces=passed root_state_surface=passed agentos_reserved_surface=passed actions=passed active_actions=passed custom=passed dynamic=passed workbench=passed notebook=passed portability=passed coherence=passed static_site=passed artifacts=passed workflow=passed collaboration=passed ui=passed web=passed llm=passed startup=passed review_dashboard=passed review_pack=passed compare=passed status=passed\n");
	return 0;
}
