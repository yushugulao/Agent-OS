...
int main(void)
{
	...
	if (!rp_append_file("rp_agentcmp", "project_delivery_kernel_binding=file_metadata_index,event_delivery,context_release_evidence,capability_guard;source=rp_projectrel;status=ready")) return 1;
