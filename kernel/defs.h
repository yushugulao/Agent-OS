...
void            agent_free_shadow_context(uint64*);
int             agent_map_context(struct proc*, pagetable_t);
int             agent_init_context(struct proc*, pagetable_t);
int             agent_info_copyout(uint64);
int             agent_tool_call(uint64, uint64);
int             agent_run(uint64, uint64, int, uint64);
int             agent_tool_list(uint64, int);
int             agent_context_push(uint64);
int             agent_context_query(uint64, uint64, int);
