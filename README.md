...
rp_artifact_ops: inputs=2 stages=5 retries=1 artifacts=4 custom_request=1 status=ready
rp_data_pipeline: files=2 snapshots=2 previews=2 quality=passed transforms=2 status=ready
rp_workflow_runner: stages=5 events=8 retries=1 cache_hits=1 custom_runs=1 status=ready
...
rp_ui_export: pages=5 run=RUN-042 custom=usable-run:RUN-900 compare=ready status=ready
rp_web_export: routes=18 api_payloads=14 actions=5 bundle=ready status=ready
rp_test_suite: tests=132 catalog=passed data=passed services=passed actions=passed custom=passed artifacts=passed workflow=passed collaboration=passed ui=passed web=passed llm=passed compare=passed status=passed
