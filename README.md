...
`local-e3` 会校验精确的硬件、MSYS2 runtime、工具文件和配置身份。`14607e825f06`
的完整三轮校准只属于该历史提交；当前配置为 `provisional_requires_full_suite`，必须在
最终冻结提交完成三轮重校准后才能重新启用本地时长门。受管输入、profile 或证据任一漂移
