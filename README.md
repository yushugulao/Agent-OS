...
`rp_orch` runs thirty-nine platform programs as separate uCore user processes:
...
rp_test_suite: tests=260 catalog=passed data=passed services=passed actions=passed custom=passed artifacts=passed workflow=passed collaboration=passed ui=passed web=passed llm=passed compare=passed status=passed
rp_compare_plain: plain_kernel=passed objects=500 programs=39 state_files=169 acks=39 tools=142 status=ready
