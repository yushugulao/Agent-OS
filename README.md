...
`rp_orch` runs thirty-six platform programs as separate uCore user processes:
...
- More executable checks for workflow portability, workflow runner execution, release review, and AgentCompare comparison.
