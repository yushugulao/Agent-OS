...
int main(void)
{
	...
	ok = ok && rp_file_contains("rp_agentos_recovery", "kernel_tool=rerun_stage,write_report");
	...
	if (!rp_write_file("rp_backend",
			   ...
			   "runner=agentos-kernel-assisted;inputs=rp_wfio,rp_stage_state,rp_retry_plan,rp_artifact_manifest,rp_agentos_kernel,rp_agentos_mainflow,rp_agentos_recovery,rp_agentos_query,rp_agentos_timeline,rp_agentos_audit,rp_agentos_workbench,rp_agentos_package,rp_agentos_real_task;outputs=rp_backend_exec,rp_study\n"
			   "cases=7\n"
			   "executable=7\n"
			   "planned=0\n"
			   "plain_ucore=ready\n"
	...
	if (!rp_write_file("rp_backend_exec",
			   ...
			   "runner_case=agentos-recovery;input=rp_agentos_recovery;artifact=rp_fix;result=passed;reason=kernel_rerun_stage;input_check=pass;artifact_check=pass;att=1;retry=kernel_tool;ticks=1\n"
			   ...
			   "runner_detail=agentos-recovery;src=rp_agentos_recovery;req=rerun_stage+write_report;obs=pass;act=kernel_tools;review=verified\n"
			   ...
			   "runner_report=agentos-recovery;plain_cost=manual_retry_contract;agentos_replace=capability_checked_rerun;risk=wrong_stage_update;status=passed\n"
			   ...
			   "runner_observed=rp_stage_state,rp_retry_plan,rp_artifact_manifest,rp_llmeval,rp_agentos_kernel,rp_agentos_mainflow,rp_agentos_recovery,rp_agentos_query,rp_agentos_timeline,rp_agentos_audit,rp_agentos_workbench,rp_agentos_package,rp_agentos_real_task\n"
	...
	if (!rp_write_file("rp_study",
			   ...
			   "study_metric=agentos_ucore;context_trusted=1;batch_tools=1;metadata_index=1;event_queue=1;recovery_tool=1;audit_ledger=1;permission_control=1;timeline_observe=1;workbench_verify=1;package_trace=1;real_task_context=1;mainflow_facts=10;detail_checks=kernel;result=passed\n"
	...
	printf("rp_backend: cases=7 executable=7 agentos=mainflow_bound exports=1 status=ready\n");
	return 0;
}
