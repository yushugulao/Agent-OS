...
int main(void)
{
	...
	if (!rp_write_file("rp_web_routes",
			   ...
			   "host_dynamic_page_prefixes=12\n"
			   "ucore_dynamic_page_prefixes=12\n"
			   "host_download_routes=16\n"
			   "ucore_download_routes=16\n"
			   ...
			   "prefix=/runs/{run_id};payload=rp_api_run;status=ready\n"
			   "prefix=/study-protocol-launch/{id};payload=rp_studyproto;status=ready\n"
			   "prefix=/study-protocol-reproduction-package/{id};payload=rp_studyproto;status=ready\n"
			   "prefix=/research-project/{id};payload=rp_usableproj;status=ready\n"
			   "prefix=/workbench-files/{token};payload=rp_runner;status=ready\n"
			   "prefix=/workbench-file/{token};payload=rp_runner;status=ready\n"
			   "prefix=/workbench/{id};payload=rp_runner;status=ready\n"
			   "prefix=/research/{run_id};payload=rp_uresrun;status=ready\n"
			   "prefix=/provenance/{id};payload=rp_prov_view;status=ready\n"
			   "prefix=/llm/{id};payload=rp_llm_resp;status=ready\n"
			   "prefix=/agents/{id};payload=rp_api_agents;status=ready\n"
			   "prefix=/evidence/{id};payload=rp_api_evidence;status=ready\n"
			   "download=/download/research-dataset-preview/{token};payload=rp_usableds;status=ready\n"
			   "download=/download/research-dataset-visualization/{token};payload=rp_usableds;status=ready\n"
			   "download=/download/research-dataset-card/{token};payload=rp_usableds;status=ready\n"
			   "download=/download/research-dataset-answer/{token};payload=rp_usableds;status=ready\n"
			   "download=/download/research-dataset-run-comparison/{token};payload=rp_usableds;status=ready\n"
			   "download=/download/research-dataset-portfolio/{token};payload=rp_usableds;status=ready\n"
			   "download=/download/research-source-portfolio/{token};payload=rp_usablelib;status=ready\n"
			   "download=/download/research-study-protocol/{token};payload=rp_studyproto;status=ready\n"
			   "download=/download/research-study-protocol-run/{token};payload=rp_studyproto;status=ready\n"
			   "download=/download/research-study-protocol-compliance/{token};payload=rp_studyproto;status=ready\n"
			   "download=/download/research-study-protocol-bundle/{token};payload=rp_studyproto;status=ready\n"
			   "download=/download/research-study-protocol-launch/{token};payload=rp_studyproto;status=ready\n"
			   "download=/download/research-study-protocol-launch-comparison/{token};payload=rp_studyproto;status=ready\n"
			   "download=/download/research-study-protocol-reproduction-package/{token};payload=rp_usablepack;status=ready\n"
			   "download=/download/research-study-protocol-reproduction-package-action-plan/{token};payload=rp_usablepack;status=ready\n"
			   "download=/download/research-study-protocol-reproduction-package-action-execution/{token};payload=rp_usablepack;status=ready\n"
			   ...
			   "action=/actions/research/sample-workbench;method=POST;payload=rp_api_action;status=ready\n"
			   "action=/actions/research/workbench;method=POST;payload=rp_api_action;status=ready\n"
			   "action=/actions/research/workbench-advance;method=POST;payload=rp_api_action;status=ready\n"
			   "action=/actions/research/workbench-auto-advance;method=POST;payload=rp_api_action;status=ready\n"
			   "action=/actions/research/workbench-complete;method=POST;payload=rp_api_action;status=ready\n"
			   "action=/actions/research/workbench-task;method=POST;payload=rp_api_action;status=ready\n"
			   "action=/actions/research/workbench-task-board;method=POST;payload=rp_api_action;status=ready\n"
			   "action=/actions/research/workbench-task-board-row;method=POST;payload=rp_api_action;status=ready\n"
			   "action=/actions/research/workbench-note;method=POST;payload=rp_api_action;status=ready\n"
			   "action=/actions/research/workbench-notes;method=POST;payload=rp_api_action;status=ready\n"
			   "action=/actions/research/workbench-handoff-package;method=POST;payload=rp_api_action;status=ready\n"
			   "action=/actions/research/workbench-readiness;method=POST;payload=rp_api_action;status=ready\n"
			   "action=/actions/research/workbench-answer;method=POST;payload=rp_api_action;status=ready\n"
			   "action=/actions/research/workbench-answer-audit;method=POST;payload=rp_api_action;status=ready\n"
			   "action=/actions/research/workbench-evidence-search;method=POST;payload=rp_api_action;status=ready\n"
			   "action=/actions/research/workbench-brief;method=POST;payload=rp_api_action;status=ready\n"
			   "action=/actions/research/workbench-evidence-dossier;method=POST;payload=rp_api_action;status=ready\n"
			   "action=/actions/research/workbench-evidence-graph;method=POST;payload=rp_api_action;status=ready\n"
			   "action=/actions/research/workbench-citations;method=POST;payload=rp_api_action;status=ready\n"
			   "action=/actions/research/workbench-manuscript;method=POST;payload=rp_api_action;status=ready\n"
			   "action=/actions/research/workbench-manuscript-audit;method=POST;payload=rp_api_action;status=ready\n"
			   "action=/actions/research/workbench-manuscript-revision-plan;method=POST;payload=rp_api_action;status=ready\n"
			   "action=/actions/research/workbench-manuscript-revision-task;method=POST;payload=rp_api_action;status=ready\n"
			   "action=/actions/research/workbench-runbook;method=POST;payload=rp_api_action;status=ready\n"
			   "action=/actions/research/workbench-timeline;method=POST;payload=rp_api_action;status=ready\n"
			   "action=/actions/research/workbench-file-manifest;method=POST;payload=rp_api_action;status=ready\n"
			   "action=/actions/research/workbench-file-verify;method=POST;payload=rp_api_action;status=ready\n"
			   "action=/actions/research/export;method=POST;payload=rp_api_action;status=ready\n"
			   "action=/actions/research/export-workbench;method=POST;payload=rp_api_action;status=ready\n"
			   "action=/actions/research/export-bundle;method=POST;payload=rp_api_action;status=ready\n"
			   "action=/actions/research/export-notebook;method=POST;payload=rp_api_action;status=ready\n"
			   "action=/actions/research/review;method=POST;payload=rp_api_action;status=ready\n"
			   "action=/actions/research/delivery;method=POST;payload=rp_api_action;status=ready\n"
			   "action=/actions/research/rerun;method=POST;payload=rp_api_action;status=ready\n"
			   "action=/actions/research/revision-task;method=POST;payload=rp_api_action;status=ready\n"
			   "action=/actions/research/run-revision;method=POST;payload=rp_api_action;status=ready\n"
			   "action=/actions/research/run-revision-task;method=POST;payload=rp_api_action;status=ready\n"
			   "action=/actions/research/template;method=POST;payload=rp_api_action;status=ready\n"
			   "action=/actions/research/dataset;method=POST;payload=rp_api_action;status=ready\n"
			   "action=/actions/research/dataset-preview;method=POST;payload=rp_api_action;status=ready\n"
			   "action=/actions/research/dataset-visualization;method=POST;payload=rp_api_action;status=ready\n"
			   "action=/actions/research/dataset-card;method=POST;payload=rp_api_action;status=ready\n"
			   "action=/actions/research/dataset-answer;method=POST;payload=rp_api_action;status=ready\n"
			   "action=/actions/research/dataset-run;method=POST;payload=rp_api_action;status=ready\n"
			   "action=/actions/research/dataset-run-comparison;method=POST;payload=rp_api_action;status=ready\n"
			   "action=/actions/research/dataset-portfolio;method=POST;payload=rp_api_action;status=ready\n"
			   "action=/actions/research/library-source;method=POST;payload=rp_api_action;status=ready\n"
			   "action=/actions/research/source-portfolio;method=POST;payload=rp_api_action;status=ready\n"
			   "action=/actions/research/inspect-workspace;method=POST;payload=rp_api_action;status=ready\n"
			   "action=/actions/research/import-workspace;method=POST;payload=rp_api_action;status=ready\n"
			   "action=/actions/research/import-and-run;method=POST;payload=rp_api_action;status=ready\n"
			   "action=/actions/research/literature-search;method=POST;payload=rp_api_action;status=ready\n"
			   "action=/actions/research/evidence-review;method=POST;payload=rp_api_action;status=ready\n"
			   "action=/actions/research/evidence-protocol;method=POST;payload=rp_api_action;status=ready\n"
			   "action=/actions/research/study-protocol;method=POST;payload=rp_api_action;status=ready\n"
			   "action=/actions/research/run-study-protocol;method=POST;payload=rp_api_action;status=ready\n"
			   "action=/actions/research/study-protocol-compliance;method=POST;payload=rp_api_action;status=ready\n"
			   "action=/actions/research/study-protocol-bundle;method=POST;payload=rp_api_action;status=ready\n"
			   "action=/actions/research/study-protocol-launch;method=POST;payload=rp_api_action;status=ready\n"
			   "action=/actions/research/study-protocol-launch-rerun;method=POST;payload=rp_api_action;status=ready\n"
			   "action=/actions/research/study-protocol-launch-comparison;method=POST;payload=rp_api_action;status=ready\n"
			   "action=/actions/research/study-protocol-reproduction-package;method=POST;payload=rp_api_action;status=ready\n"
			   "action=/actions/research/study-protocol-reproduction-package-review;method=POST;payload=rp_api_action;status=ready\n"
			   "action=/actions/research/study-protocol-reproduction-package-action-plan;method=POST;payload=rp_api_action;status=ready\n"
			   "action=/actions/research/study-protocol-reproduction-package-action-execute;method=POST;payload=rp_api_action;status=ready\n"
	...
	if (!rp_write_file("rp_api_action",
			   ...
			   "sample_workbench=/actions/research/sample-workbench\n"
			   "workbench=/actions/research/workbench\n"
			   "workbench_advance_action=/actions/research/workbench-advance\n"
			   "workbench_auto_advance=/actions/research/workbench-auto-advance\n"
			   "workbench_complete=/actions/research/workbench-complete\n"
			   "workbench_task=/actions/research/workbench-task\n"
			   "workbench_task_board=/actions/research/workbench-task-board\n"
			   "workbench_task_board_row=/actions/research/workbench-task-board-row\n"
			   "workbench_note=/actions/research/workbench-note\n"
			   "workbench_notes=/actions/research/workbench-notes\n"
			   "workbench_handoff_package=/actions/research/workbench-handoff-package\n"
			   "workbench_readiness=/actions/research/workbench-readiness\n"
			   "workbench_answer=/actions/research/workbench-answer\n"
			   "workbench_answer_audit=/actions/research/workbench-answer-audit\n"
			   "workbench_evidence_search=/actions/research/workbench-evidence-search\n"
			   "workbench_brief=/actions/research/workbench-brief\n"
			   "workbench_evidence_dossier=/actions/research/workbench-evidence-dossier\n"
			   "workbench_evidence_graph=/actions/research/workbench-evidence-graph\n"
			   "workbench_citations=/actions/research/workbench-citations\n"
			   "workbench_manuscript=/actions/research/workbench-manuscript\n"
			   "workbench_manuscript_audit=/actions/research/workbench-manuscript-audit\n"
			   "workbench_manuscript_revision_plan=/actions/research/workbench-manuscript-revision-plan\n"
			   "workbench_manuscript_revision_task=/actions/research/workbench-manuscript-revision-task\n"
			   "workbench_runbook=/actions/research/workbench-runbook\n"
			   "workbench_timeline=/actions/research/workbench-timeline\n"
			   "workbench_file_manifest=/actions/research/workbench-file-manifest\n"
			   "workbench_file_verify=/actions/research/workbench-file-verify\n"
			   "research_export=/actions/research/export\n"
			   "workbench_export=/actions/research/export-workbench\n"
			   "bundle_export=/actions/research/export-bundle\n"
			   "notebook_export=/actions/research/export-notebook\n"
			   "dynamic_submit=/actions/research/run\n"
			   "live_update_feed=rp_web_bundle\n"
			   "reader_contract=rp_web_bundle\n"
			   "research_review=/actions/research/review\n"
			   "research_delivery=/actions/research/delivery\n"
			   "research_rerun=/actions/research/rerun\n"
			   "research_revision_task=/actions/research/revision-task\n"
			   "research_run_revision_legacy=/actions/research/run-revision\n"
			   "research_run_revision=/actions/research/run-revision-task\n"
			   "template=/actions/research/template\n"
			   "dataset=/actions/research/dataset\n"
			   "dataset_preview=/actions/research/dataset-preview\n"
			   "dataset_visualization=/actions/research/dataset-visualization\n"
			   "dataset_card=/actions/research/dataset-card\n"
			   "dataset_answer=/actions/research/dataset-answer\n"
			   "dataset_run=/actions/research/dataset-run\n"
			   "dataset_run_comparison=/actions/research/dataset-run-comparison\n"
			   "dataset_portfolio=/actions/research/dataset-portfolio\n"
			   "library_source=/actions/research/library-source\n"
			   "source_portfolio=/actions/research/source-portfolio\n"
			   "workspace_inspect=/actions/research/inspect-workspace\n"
			   "workspace_import=/actions/research/import-workspace\n"
			   "workspace_import_run=/actions/research/import-and-run\n"
			   "literature_search=/actions/research/literature-search\n"
			   "evidence_review=/actions/research/evidence-review\n"
			   "evidence_protocol=/actions/research/evidence-protocol\n"
			   "study_protocol=/actions/research/study-protocol\n"
			   "study_protocol_run=/actions/research/run-study-protocol\n"
			   "study_protocol_compliance=/actions/research/study-protocol-compliance\n"
			   "study_protocol_bundle=/actions/research/study-protocol-bundle\n"
			   "study_protocol_launch=/actions/research/study-protocol-launch\n"
			   "study_protocol_launch_rerun=/actions/research/study-protocol-launch-rerun\n"
			   "study_protocol_launch_comparison=/actions/research/study-protocol-launch-comparison\n"
			   "study_protocol_reproduction_package=/actions/research/study-protocol-reproduction-package\n"
			   "study_protocol_reproduction_package_review=/actions/research/study-protocol-reproduction-package-review\n"
			   "study_protocol_reproduction_package_action_plan=/actions/research/study-protocol-reproduction-package-action-plan\n"
			   ...
			   "quality_actions=3\n"
			   "delivery_actions=2\n"
			   "workbench_actions=28\n"
			   "dataset_actions=8\n"
			   "study_protocol_actions=11\n"
			   "research_input_actions=11\n"
	...
	if (!rp_write_file("rp_api_catalog",
			   ...
			   "research_api_routes=13\n"
			   "workflow_api_routes=12\n"
			   "data_api_routes=10\n"
			   "quality_api_routes=8\n"
			   "operations_api_routes=6\n"
			   "agents_api_routes=5\n"
			   "review_api_routes=5\n"
			   "llm_api_routes=4\n"
			   "provenance_api_routes=3\n"
			   "execution_api_routes=3\n"
			   "agentos_api_routes=3\n"
			   "api_group=usable_research;routes=77;state=rp_usable,rp_usableproj,rp_studyproto,rp_usableds,rp_usablelib;status=ready\n"
			   "api_group=domain;routes=50;state=rp_analysisres,rp_backend,rp_decsupport,rp_workbench,rp_modelreg;status=ready\n"
			   "api_group=lab_research;routes=15;state=rp_lab,rp_sysreview,rp_expsched,rp_traincomp,rp_stdesign;status=ready\n"
			   "api_group=research;routes=13;state=rp_runner,rp_package,rp_review_pack,rp_knowledge,rp_evidence;status=ready\n"
			   "api_group=workflow;routes=12;state=rp_stage_state,rp_wfio,rp_backend_exec,rp_execobs,rp_runconf;status=ready\n"
			   "api_group=data;routes=10;state=rp_ingest_files,rp_dataset_snapshot,rp_data_preview,rp_data_quality,rp_dataset_collection;status=ready\n"
			   "api_group=quality;routes=8;state=rp_consistency,rp_integrity,rp_coherence,rp_state_catalog;status=ready\n"
			   ...
			   "api_key=/api/dataset-snapshots;group=data;state=rp_dataset_snapshot;status=ready\n"
			   "api_key=/api/decision-support;group=domain;state=rp_decsupport;status=ready\n"
			   "api_key=/api/execution-control;group=execution;state=rp_execobs;status=ready\n"
			   "api_key=/api/experiment-scheduling;group=lab_research;state=rp_expsched;status=ready\n"
			   "api_key=/api/llm-bridge;group=llm;state=rp_llm_req,rp_llm_resp;status=ready\n"
			   "api_key=/api/llm-providers;group=llm;state=rp_llm_guard;status=ready\n"
			   "api_key=/api/model-registry;group=domain;state=rp_modelreg;status=ready\n"
			   "api_key=/api/provenance-queries;group=provenance;state=rp_prov_query;status=ready\n"
			   "api_key=/api/review-board;group=review;state=rp_reviewboard;status=ready\n"
			   "api_key=/api/run-telemetry;group=workflow;state=rp_execobs,rp_metrics;status=ready\n"
