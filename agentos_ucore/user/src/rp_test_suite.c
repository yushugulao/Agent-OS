...
int main(void)
{
	...
	ok = ok && require_file_token("rp_backend_exec", "runner_cases=7");
	...
	ok = ok && require_file_token("rp_backend_exec", "runner_case=agentos-recovery;input=rp_agentos_recovery;artifact=rp_fix;result=passed;reason=kernel_rerun_stage;input_check=pass;artifact_check=pass;att=1;retry=kernel_tool;ticks=1");
	...
	ok = ok && require_file_token("rp_backend_exec", "runner_detail=agentos-recovery;src=rp_agentos_recovery;req=rerun_stage+write_report;obs=pass;act=kernel_tools;review=verified");
	...
	ok = ok && require_file_token("rp_backend_exec", "runner_report=agentos-recovery;plain_cost=manual_retry_contract;agentos_replace=capability_checked_rerun;risk=wrong_stage_update;status=passed");
	...
	ok = ok && require_file_token("rp_backend_exec", "runner_passed=7");
	...
	ok = ok && require_file_token("rp_agentcmp", "passed_cases=7");
	ok = ok && require_file_token("rp_agentcmp", "planned_cases=0");
	ok = ok && require_file_token("rp_agentcmp", "backend_runner_checks=21");
	ok = ok && require_file_token("rp_agentcmp", "backend_runner_detail_checks=42");
	ok = ok && require_file_token("rp_agentcmp", "runner_detail_rows=7");
	ok = ok && require_file_token("rp_agentcmp", "backend_runner_report_checks=35");
	ok = ok && require_file_token("rp_agentcmp", "runner_report_rows=7");
