...
int main(void)
{
	...
	ok = ok && require_file_token("rp_backend_exec", "runner_cases=4");
	...
	ok = ok && require_file_token("rp_backend_exec", "runner_observed=rp_stage_state,rp_retry_plan,rp_artifact_manifest,rp_llmeval,rp_agentos_kernel");
	...
	ok = ok && require_file_token("rp_backend_exec", "runner_passed=4");
	...
	ok = ok && require_file_token("rp_study", "study_metric=agentos_ucore;context_trusted=1;batch_tools=1;metadata_index=1;detail_checks=kernel;result=passed");
	...
	ok = ok && require_file_token("rp_study", "agentos_kernel=observed");
	...
	ok = ok && require_file_token("rp_query", "knowledge_index=search_documents:1385");
	ok = ok && require_file_token("rp_query", "provenance_nodes:406");
	ok = ok && require_file_token("rp_query", "provenance_links:544");
	ok = ok && require_file_token("rp_query", "events:6816");
	ok = ok && require_file_token("rp_query", "context_records:348");
	ok = ok && require_file_token("rp_query", "host_workflow_artifacts:150");
	ok = ok && require_file_token("rp_query", "usable_artifacts:429");
	ok = ok && require_file_token("rp_query", "usable_runs:20");
	ok = ok && require_file_token("rp_query", "usable_stages:168");
	ok = ok && require_file_token("rp_query", "usable_messages:223");
	ok = ok && require_file_token("rp_query", "usable_decisions:203");
	ok = ok && require_file_token("rp_llmlog", "transcripts=90");
	ok = ok && require_file_token("rp_llmlog", "bridge_requests=30");
	ok = ok && require_file_token("rp_llmlog", "bridge_responses=30");
	ok = ok && require_file_token("rp_runner", "workbench_delivery_scale=workbenches:5");
	ok = ok && require_file_token("rp_runner", "templates:5");
	ok = ok && require_file_token("rp_runner", "workspace_imports:5");
	ok = ok && require_file_token("rp_runner", "workspace_inspections:5");
	ok = ok && require_file_token("rp_runner", "answers:5");
	ok = ok && require_file_token("rp_runner", "deliveries:6");
	ok = ok && require_file_token("rp_runner", "studio_sessions:2");
	ok = ok && require_file_token("rp_runner", "project_action_plans:15");
	ok = ok && require_file_token("rp_runner", "project_deliveries:4");
	ok = ok && require_file_token("rp_runner", "project_runbooks:15");
	ok = ok && require_file_token("rp_runner", "project_evidence_audits:15");
	ok = ok && require_file_token("rp_runner", "project_provenance_graphs:3");
	...
	ok = ok && require_file_token("rp_state_catalog", "host_state_keys=573");
	ok = ok && require_file_token("rp_state_catalog", "nonzero_state_categories=70");
	ok = ok && require_file_token("rp_state_catalog", "zero_state_categories=503");
	ok = ok && require_file_token("rp_state_catalog", "represented_state_categories=573");
	...
	ok = ok && require_file_token("rp_agentcmp", "research_portfolio=sources:42");
	ok = ok && require_file_token("rp_consistency", "usable_research_sources=42");
	...
	ok = ok && require_file_token("rp_agentcmp", "agentcompare_execution_scale=reports:3");
	ok = ok && require_file_token("rp_agentcmp", "host_runtime_scale=workflow_runs:10");
	ok = ok && require_file_token("rp_agentcmp", "content_graph_scale=content_objects:145");
	ok = ok && require_file_token("rp_consistency", "host_workflow_stage_runs=70");
	ok = ok && require_file_token("rp_consistency", "agentcompare_results=15");
	...
	ok = ok && require_file_token("rp_consistency", "search_documents=1385");
	ok = ok && require_file_token("rp_consistency", "provenance_nodes=406");
	ok = ok && require_file_token("rp_consistency", "provenance_links=544");
	ok = ok && require_file_token("rp_consistency", "event_stream_records=6816");
	ok = ok && require_file_token("rp_consistency", "context_records=348");
	...
	ok = ok && require_file_token("rp_ui_compare", "agentos_kernel=observed");
	...
	ok = ok && require_file_token("rp_web_routes", "routes=77");
	...
	ok = ok && require_file_token("rp_web_routes", "post_routes=60");
	...
	ok = ok && require_file_token("rp_api_compare", "agentos_kernel=observed");
	...
	ok = ok && require_file_token("rp_api_action", "actions=60");
	...
	ok = ok && require_file_token("rp_web_bundle", "reader_views=39");
	ok = ok && require_file_token("rp_web_bundle", "reader_actions=60");
	...
	ok = ok && require_file_token("rp_web_bundle", "post_routes=60");
	...
	ok = ok && require_file_token("rp_agentcmp", "knowledge_index=search_documents:1385");
	ok = ok && require_file_token("rp_agentcmp", "provenance_nodes:406");
	ok = ok && require_file_token("rp_agentcmp", "provenance_links:544");
	ok = ok && require_file_token("rp_agentcmp", "events:6816");
	ok = ok && require_file_token("rp_agentcmp", "context_records:348");
	ok = ok && require_file_token("rp_agentcmp", "usable_artifacts:429");
	ok = ok && require_file_token("rp_agentcmp", "usable_runs:20");
	ok = ok && require_file_token("rp_agentcmp", "llm_transcripts=90");
	ok = ok && require_file_token("rp_agentcmp", "workbenches=5");
	ok = ok && require_file_token("rp_agentcmp", "deliveries=6");
	ok = ok && require_file_token("rp_agentcmp", "project_action_plans=15");
	...
	ok = ok && require_file_token("rp_agentcmp", "passed_cases=4");
	...
	ok = ok && require_file_token("rp_runop", "source_portfolio=sources:42");
	ok = ok && require_file_token("rp_runop", "research_portfolio_scale=sources:42");
	ok = ok && require_file_token("rp_runop", "datasets:3");
	ok = ok && require_file_token("rp_runop", "literature_searches:4");
	ok = ok && require_file_token("rp_runop", "reviews:8");
	ok = ok && require_file_token("rp_runop", "evidence_reviews:4");
	ok = ok && require_file_token("rp_runop", "evidence_extractions:15");
	ok = ok && require_file_token("rp_runop", "screening_decisions:15");
	ok = ok && require_file_token("rp_runop", "exports:66");
	ok = ok && require_file_token("rp_runop", "doctor_reports:10");
	ok = ok && require_file_token("rp_runop", "project_handoff_audits:30");
	ok = ok && require_file_token("rp_runop", "project_run_comparisons:15");
	ok = ok && require_file_token("rp_runop", "project_reproducibility_audits:15");
	ok = ok && require_file_token("rp_runop", "project_snapshot_comparisons:15");
