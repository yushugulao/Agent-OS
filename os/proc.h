...
struct proc {
	...
	uint64 agent_tool_grant_mask;
	uint64 agent_prompt_artifact_handle;
	uint64 agent_artifact_bytes_limit;
	uint64 agent_artifact_read_limit;
	uint agent_artifact_count_limit;
	uint agent_summary_high_watermark;
	uint agent_prefetch_enabled;
	uint agent_prefetch_policy;
	uint agent_prefetch_min_observations;
	uint agent_prefetch_confidence_threshold_ppm;
	uint agent_prefetch_max_bytes;
	uint agent_prefetch_max_inflight;
	uint agent_prefetch_inflight;
	uint agent_prefetch_hits;
	uint agent_prefetch_misses;
	uint agent_prefetch_cancelled;
	uint agent_prefetch_denied;
	uint agent_prefetch_reserved;
	uint64 agent_prefetch_last_signature_hash;
	uint64 agent_prefetch_last_training_sequence;
	uint64
...
int agent_runtime_create_proc(const struct agent_runtime_config *);
