...
#define AGENT_TOOL_SECURITY_REGISTRY(X) \
	...
	X(AGENT_CAP_WORKSPACE_WRITE, PROV_ACCEPT_AGENT_LOOP, PROV_DERIVED, AGENT_SIDE_EFFECT_FILE | AGENT_SIDE_EFFECT_METADATA | AGENT_SIDE_EFFECT_IPC | AGENT_SIDE_EFFECT_ARTIFACT) \
	X(AGENT_CAP_WORKSPACE_WRITE, PROV_ACCEPT_AGENT_LOOP, PROV_DERIVED, AGENT_SIDE_EFFECT_FILE | AGENT_SIDE_EFFECT_METADATA | AGENT_SIDE_EFFECT_IPC | AGENT_SIDE_EFFECT_ARTIFACT) \
	X(AGENT_CAP_CONTENT_READ, PROV_ACCEPT_AGENT_LOOP, PROV_FILE, AGENT_SIDE_EFFECT_FILE | AGENT_SIDE_EFFECT_METADATA | AGENT_SIDE_EFFECT_IPC | AGENT_SIDE_EFFECT_WATCH | AGENT_SIDE_EFFECT_ARTIFACT) \
	X(AGENT_CAP_CONTENT_READ, PROV_ACCEPT_AGENT_LOOP, PROV_FILE, AGENT_SIDE_EFFECT_FILE | AGENT_SIDE_EFFECT_METADATA | AGENT_SIDE_EFFECT_IPC | AGENT_SIDE_EFFECT_WATCH | AGENT_SIDE_EFFECT_ARTIFACT) \
	X(AGENT_CAP_PROCESS_READ, PROV_ACCEPT_AGENT_LOOP, PROV_FACT, 0) \
	X(AGENT_CAP_CONTENT_READ | AGENT_CAP_WORKSPACE_WRITE, PROV_ACCEPT_AGENT_LOOP, PROV_TOOL, AGENT_SIDE_EFFECT_FILE | AGENT_SIDE_EFFECT_PROCESS | AGENT_SIDE_EFFECT_METADATA | AGENT_SIDE_EFFECT_IPC | AGENT_SIDE_EFFECT_ARTIFACT) \
	X(AGENT_CAP_CONTENT_READ, PROV_ACCEPT_AGENT_LOOP, PROV_TOOL, AGENT_SIDE_EFFECT_FILE | AGENT_SIDE_EFFECT_PROCESS | AGENT_SIDE_EFFECT_METADATA | AGENT_SIDE_EFFECT_IPC | AGENT_SIDE_EFFECT_ARTIFACT)
