...
| `rp_web_routes` | Host Web/API export | test suite, compare, orchestrator | route manifest for fourteen host-rendered GET views and thirty-one POST action entries |
