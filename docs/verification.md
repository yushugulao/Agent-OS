...
rp_web_export: routes=42 api_payloads=14 actions=28 bundle=ready status=ready
...
rp_compare_plain: plain_kernel=passed objects=500 programs=42 state_files=168 acks=42 tools=136 dynamic=4 reader=1 status=ready
