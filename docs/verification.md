...
- user-space test suite with 2120 checks over catalog records, service records, Host Reader export files, workflow runner files, artifact files, delivery files, review files, LLM relay files, calculation job records, real task validation records, experiment campaign records, statistical design records, model registry records, release dossier records, mature platform mappings, provenance views, provenance query records, Agent collaboration records, AgentCompare records, and cross-file consistency records.
