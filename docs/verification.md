...
- multi-process execution with fifty-six ordinary uCore user programs.
...
- user-space test suite with 1504 checks over catalog records, service records, Host Reader export files, workflow runner files, artifact files, delivery files, review files, LLM relay files, mature platform mappings, provenance views, provenance query records, Agent collaboration records, AgentCompare records, and cross-file consistency records.
