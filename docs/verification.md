...
- host-side LLM relay execution over ordinary state files, with offline template responses, cloud-configuration detection, prompt hashes, and no secret values written back to uCore state.
