...
"""
    ...
    def test_mutations_are_rejected(self) -> None:
        cases = (
            ...
            ("store_format", "&store->records[i]", "&store->records[0]"),
            ("store_format", "&store->records[j]", "&store->records[0]"),
            ("store_format", "workflow_lifecycle_key_valid(lifecycle)",
             "lifecycle.id != 0"),
            ("store_format",
             "records_valid(store);",
             "1;"),
            ("store_format", "(record->meta.logical_path[0] &&",
            ...
            ("scope_program", "i < WORKFLOW_AUTOSCAN_SCOPE_LIMIT ?",
            ...
            ("scope_program",
             ...
             "check(1, \"reload rebound autoscan catalog checkpoint\");"),
            ("scope_program",
