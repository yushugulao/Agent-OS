...
require_text "host_tools/summarize_dual_platform_results.py" "scenario-evidence.svg" "result summarizer does not generate the scenario evidence chart"
...
require_text "host_tools/summarize_dual_platform_results.py" "runner-statistics.csv" "result summarizer does not write runner statistics csv"
require_text "host_tools/summarize_dual_platform_results.py" "runner-statistics.html" "result summarizer does not generate runner statistics page"
require_text "host_tools/summarize_dual_platform_results.py" "runner-statistics.svg" "result summarizer does not generate runner statistics chart"
require_text "host_tools/summarize_dual_platform_results.py" "load-profile.csv" "result summarizer does not write load profile csv"
require_text "host_tools/summarize_dual_platform_results.py" "load-profile.svg" "result summarizer does not generate load profile chart"
require_text "host_tools/summarize_dual_platform_results.py" "chart-type-coverage.csv" "result summarizer does not write chart type coverage csv"
require_text "host_tools/summarize_dual_platform_results.py" "runner-cumulative-line.svg" "result summarizer does not generate line chart"
require_text "host_tools/summarize_dual_platform_results.py" "runner-tick-box.svg" "result summarizer does not generate box chart"
require_text "host_tools/summarize_dual_platform_results.py" "runner-cost-heatmap.svg" "result summarizer does not generate heatmap chart"
require_text "host_tools/summarize_dual_platform_results.py" "stage-monitor-area.svg" "result summarizer does not generate monitor area chart"
require_text "host_tools/summarize_dual_platform_results.py" "runner-surface-composite.svg" "result summarizer does not generate surface/projection/heatmap composite chart"
...
require_text "host_tools/summarize_dual_platform_results.py" "demo-guide.html" "result summarizer does not generate the demo guide page"
...
require_text "host_tools/summarize_dual_platform_results.py" "demo-checklist.csv" "result summarizer does not write demo checklist csv"
require_text "host_tools/summarize_dual_platform_results.py" "demo-checklist.html" "result summarizer does not generate demo checklist page"
...
require_text "host_tools/test_summarize_dual_platform_results.py" "scenario-evidence.svg" "result summary test does not check the scenario evidence chart"
...
require_text "host_tools/test_summarize_dual_platform_results.py" "runner-statistics.csv" "result summary test does not check runner statistics csv"
require_text "host_tools/test_summarize_dual_platform_results.py" "runner-statistics.html" "result summary test does not check runner statistics page"
require_text "host_tools/test_summarize_dual_platform_results.py" "runner-statistics.svg" "result summary test does not check runner statistics chart"
require_text "host_tools/test_summarize_dual_platform_results.py" "load-profile.csv" "result summary test does not check load profile csv"
require_text "host_tools/test_summarize_dual_platform_results.py" "load-profile.svg" "result summary test does not check load profile chart"
require_text "host_tools/test_summarize_dual_platform_results.py" "chart-type-coverage.csv" "result summary test does not check chart type coverage csv"
require_text "host_tools/test_summarize_dual_platform_results.py" "runner-cumulative-line.svg" "result summary test does not check line chart"
require_text "host_tools/test_summarize_dual_platform_results.py" "runner-tick-box.svg" "result summary test does not check box chart"
require_text "host_tools/test_summarize_dual_platform_results.py" "runner-cost-heatmap.svg" "result summary test does not check heatmap chart"
require_text "host_tools/test_summarize_dual_platform_results.py" "stage-monitor-area.svg" "result summary test does not check monitor area chart"
require_text "host_tools/test_summarize_dual_platform_results.py" "runner-surface-composite.svg" "result summary test does not check composite chart"
...
require_text "host_tools/test_summarize_dual_platform_results.py" "demo-guide.html" "result summary test does not check the demo guide page"
...
require_text "host_tools/test_summarize_dual_platform_results.py" "demo-checklist.csv" "result summary test does not check demo checklist csv"
require_text "host_tools/test_summarize_dual_platform_results.py" "demo-checklist.html" "result summary test does not check demo checklist page"
...
require_text "host_tools/test_chart_type_data_contract.py" "chart-type-coverage.csv" "chart data contract test does not check chart type coverage csv"
...
require_text "host_tools/test_chart_type_data_contract.py" "runner-statistics.csv" "chart data contract test does not check runner statistics csv"
require_text "host_tools/test_chart_type_data_contract.py" "runner-statistics.svg" "chart data contract test does not check runner statistics chart"
require_text "host_tools/test_chart_type_data_contract.py" "load-profile.csv" "chart data contract test does not check load profile csv"
...
require_text "host_tools/test_chart_type_data_contract.py" "runner-surface-composite.svg" "chart data contract test does not check composite chart data"
...
require_text "scripts/serve-demo-reader.sh" "dual-results/demo-guide.html" "demo reader script does not expose demo guide under the Reader service"
require_text "scripts/serve-demo-reader.sh" "demo-url-list.txt" "demo reader script does not generate the URL list"
require_text "scripts/serve-demo-reader.sh" "dual-results/test-suite.html" "demo reader script does not expose test suite page"
require_text "scripts/serve-demo-reader.sh" "dual-results/experiment-design.html" "demo reader script does not expose experiment design page"
require_text "scripts/serve-demo-reader.sh" "dual-results/evidence-map.html" "demo reader script does not expose evidence map page"
...
require_text "host_tools/test_plain_ucore_reader.py" "dual-results/demo-guide.html" "Host Reader test does not cover nested demo guide serving"
require_text "host_tools/test_plain_ucore_reader.py" "demo-url-list.txt" "Host Reader test does not cover URL list serving"
require_text "host_tools/test_plain_ucore_reader.py" "dual-results/test-suite.html" "Host Reader test does not cover nested test suite serving"
